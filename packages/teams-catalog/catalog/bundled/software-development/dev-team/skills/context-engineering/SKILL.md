...
In this eco-system, the user also maintains a personal `~/.claude/CLAUDE.md` overlay for durable working-style preferences. Project-level CLAUDE.md overrides personal CLAUDE.md for project-specific concerns.
